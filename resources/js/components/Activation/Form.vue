<template>
    <fieldset class="container">
        <div class="form-group row field">
            <label class="col-sm-3 col-form-label">Current Total E-Wallet:</label>
            <div class="col-sm-4">
                <span class="form-control form-control-sm border-0">PHP {{ member.total_amt }}</span>
            </div>
        </div>
        <div class="form-group row field">
        ...
        <div class="form-group row field">
            ...
            <div class="col-sm-4">
                ...
                <input type="hidden" v-model="model.quantity" name="quantity" class="form-control form-control-sm"/>
            </div>
        </div>
        <div class="form-group row field">
