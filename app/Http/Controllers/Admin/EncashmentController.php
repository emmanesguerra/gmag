...
{
    /**
     * Display a listing of the encashment requests of the members.
     *
    ...
    /**
     * Return the list of encashment requests created by the members
     *
     ...
     * 
     * @queryParam tracking_no string required
     * Tracking number. Example: TRAN0001
     * 
     * @queryParam remarks string optional
     * Remarks. Example: Sample request
     * 
     * @queryParam id string required
     * Encashment ID. Example: 5
     *
     * @return \Illuminate\Http\Response
     */
    ...
    /**
     * Query encashment request status
     * 
     * @queryParam id string required
     * Encashment ID. Example: 5
     *
