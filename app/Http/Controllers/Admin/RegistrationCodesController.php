...
/**
 * @group Admin/Registration Codes
 *
 */
class RegistrationCodesController extends Controller
{
    /**
     * Display a listing of the available codes.
     *
    ...
    /**
     * Return the list of recorded available codes
     *
    ...
    /**
     * Display a listing of the used codes.
     *
     * @queryParam request array required 
     * JSON request generated by DataTable
     *
    ...
    /**
     * Return the list of recorded used codes
     *
     * @return \Illuminate\Http\Response
     */
    ...
    /**
     * Show the form for creating a new registration codes.
     *
     * @return \Illuminate\Http\Response
     */
    ...
    /**
     * Store a newly created registration code in storage.
     * 
     * @queryParam product_id int required
     * Product id. Example: 5
     * 
     * @queryParam code_count string required
     * Number of codes to be generated. Example: 999
     * 
     * @queryParam username string required
     * Member username. Example: GOLDENMAGTOP
     * 
     * @queryParam remarks string optional
     * Remarks. Example: This is for Goldemagtop
     * 
     * @queryParam administrator_password string required
     * Administrator Password. Example: admin
     *
    ...
    /**
     * Show the form for editing the specified registration code.
     *
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
    ...
    /**
     * Update the specified registration code in storage.
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  int  $id
     * @return \Illuminate\Http\Response
    ...
    /**
     * Remove the specified registration codes from storage.
     *
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
