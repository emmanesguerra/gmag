...
{
    /**
     * Display the Member's binary tree
     *
     * Icon Legends
     * - Black - Available
     * - Blue - Starter Package
     * - Bronze - Bronze Package
     * - Silver - Silver Package
     * - Gold - Gold Package
     * 
     * Member can register new account on Sign Up links in Black Icons
     * 
    ...
    public function pairing(Request $request)
    {
        ...
        return view('gtree-pairing-list', ['member' => $member]);
    }
    
    /**
     * Display the list of paired members
     *
    ...
    /**
     * Display the list of members under the logged in member's account
     *
     * @queryParam request array required 
     * JSON request generated by DataTable
     * 
    ...
    /**
     * Display the list of members under the logged in member's account on the LEFT side
     *
     * @queryParam request array required 
     * JSON request generated by DataTable
     * 
    ...
    /**
     * Display the list of members under the logged in member's account on the RIGHT side
     *
     * @queryParam request array required 
     * JSON request generated by DataTable
     * 
